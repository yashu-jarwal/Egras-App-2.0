...
export default StyleSheet.create({
    ...
    Textview: { fontSize: 15, fontWeight: 'bold', color: '#5EAAB8',marginHorizontal:5 },
    Resttext: { fontSize: 10, color: '#58A3AD', textAlign: 'right', marginTop: 10, fontWeight: 'bold' },
    ...
    inputView1: {
        ...
        marginBottom: 10, marginTop: 10, marginHorizontal: 8
    },
});