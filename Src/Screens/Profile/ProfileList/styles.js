...
export default StyleSheet.create({
    ...
    searchimg: { height: 20, width: 20, tintColor: Colors.black },
    ...
    centercomp: {
        marginTop: 20,
        borderRadius: 10,
        backgroundColor: '#A5F9FF',
        justifyContent: 'center',
        height: 50, flexDirection: 'row', marginHorizontal:25
    },
    ...
    input: { fontSize: 14, width: '100%', color: Colors.black, },
    appButtonContainer: {
        backgroundColor: "#08818A",
        borderRadius: 20,
        marginTop: 20,
    ...
    buttonview: { flex: 1, justifyContent: 'center', alignContent: 'center', marginBottom:10,marginRight:35},
